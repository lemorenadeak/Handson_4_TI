public class DoWhileLoopPractice {
    public static void main(String[] args) {
        ...
        do{
            System.out.println("The number " +inputValue+" is invalid");
        ...
        // Your code here:
        do {
            System.out.println("this condition is: "  + condition);
        }while (condition);
       ...
       // TODO 8: Countdown Timer
        ...
        // Your code here:
        do {
            System.out.println("enter your password: " +  enteredPassword);
            if (attemptCount < maxAttempts) {
                System.out.println("TRY AGAIN!: ");
                System.out.println("number of attempts: " + attemptCount + ",max: " + maxAttempts);
                attemptCount++;
            }
            if (attemptCount == maxAttempts) {
        ...
        do {
                ...
                currentLevel++;
                System.out.println("CONGRATULATIONS YOU HAVE LEVELED UP TO LEVEL " + currentLevel);
